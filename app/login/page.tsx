...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-coffee-50">
          ...
          {['All', 'Local', 'Western', 'Drinks', 'Dessert'].map((cat) => (
            <button
              ...
              className={`px-8 py-3 rounded-full border-2 font-black text-lg transition-all ${
                activeCategory === cat 
                ? 'bg-coffee-500 text-black border-coffee-500 shadow-lg' // Active State
                : 'bg-white border-black text-black hover:bg-black hover:text-white' // Inactive State (White on Black background)
              }`}
            >
              {cat}
            </button>
      ...
      {/* Location / Contact Section (Kept the same) */}
...
// ------------------------------------------------------------------
// MENU CARD COMPONENT (Price and Description are now BLACK for Clarity)
// ------------------------------------------------------------------
